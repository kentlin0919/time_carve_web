...
export default function ForgotPasswordPage() {
  const { form } = useForgotPasswordController();
            ...
            <form onSubmit={form.onSubmit} className="space-y-6">
              ...
              <div className="space-y-2 text-left">
                ...
                <div className="group relative">
                  ...
                  <input
                    className="block w-full rounded-xl border-slate-200 bg-slate-50 py-3.5 pl-11 pr-4 text-slate-900 outline-none transition-shadow placeholder:text-slate-400 focus:border-primary focus:ring-primary dark:border-gray-700 dark:bg-gray-900 dark:text-white sm:text-sm"
                    id="email"
                    name="email"
